...
:::{.absolute top=210px left=40px width=105px height=75px style="background-color:#cceffc; font-weight:bold; color:#000; text-align:left; z-index:999;font-size:80%!important;border-radius:5%;"}
<!-- .box-Ds5 -->
D:
:::
...
:::{.absolute top=540px left=105px width=110px height=75px style="background-color:#cceffc; font-weight:bold; color:#000; text-align:left; z-index:999;font-size:80%!important;"}
<!-- .box-Ds4 -->
S:
:::
