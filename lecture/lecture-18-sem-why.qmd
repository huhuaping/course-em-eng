...
```{r}
#| results: hide
source(here::here("lecture/code/code-chapter-18-why.R"))
```
...
```{r}
#| label: fig-scatter-truffles-left
...
```{r}
#| label: fig-scatter-truffles-right
...
```{r}
#| label: fig-scatter-YC
#| fig-cap: "The scatter of Y and C"
...
```{r}
#| label: monte-mod-tidy
#| results: asis

qx.out <- xmerit::qx.est(
  lm.mod = mod_monte$mod.C, lm.dt = monte,
  inf = c("fit", "Ftest")
  )
```
